...
| `apps/venue-control` | Control API、数据库迁移、Binance Executor、带单授权管理员工具 |
...
- [Grid 开发结构](docs/GRID_STRATEGY_ARCHITECTURE.md) / [Grid 契约与旧运行时保护](docs/GRID_RUNTIME_REFACTOR.md)。
