...
use crate::{
    ...
    indicator::{BARS_SOURCE, BOOK_SOURCE, TRADES_SOURCE},
};
...
pub enum ScalpingError {
    ...
    Symbol,
    #[error("feature frame is invalid: {0}")]
    Feature(#[from] crate::indicator::FeatureFrameError),
    ...
    Fault,
    #[error("strategy projection persistence failed: {0}")]
