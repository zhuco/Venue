...
struct EvidenceScore {
    ...
    outcome_expected_value_bps: Decimal,
    net_expected_value_bps: Decimal,
}
    ...
    fn preparation() -> Result<(CandidatePreparation, SemanticIntent), Box<dyn std::error::Error>> {
        ...
        Ok((
            CandidatePreparation {
                ...
                binding_digest: super::super::engine::digest_strategy_binding(&binding),
