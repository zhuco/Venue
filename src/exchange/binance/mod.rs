...
use order_parameters::{
    LimitTimeInForce, limit_order_parameters, market_order_parameters, market_reduce_parameters,
    stop_market_close_all_parameters, stop_market_full_position_parameters,
};
...
fn parse_trade(
    ...
    Ok(PublicTrade {
        ...
        aggregate_trade_id: number(object.get("a"))?.into(),
        first_trade_id: Some(number(object.get("f"))?),
        last_trade_id: Some(number(object.get("l"))?),
