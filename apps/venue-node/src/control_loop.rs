...
use venue_control_protocol::{
    ...
    CopyLifecyclePolicy, CopyPlanningFact, CopyRelationRecord, ExecutionFactBinding,
    ExecutionFactsSnapshot, HealthState, NodeProjectionEnvelope, ReconciliationFact,
    SignedFillFact, SignedOrderFact, SignedPositionFact, StrategyKind as ProjectionStrategyKind,
    StrategyLifecycle, StrategySummary,
};
...
fn projection_digest_for<T: serde::Serialize>(
    label: &str,
    value: &T,
