...
pub const MIGRATION_0043: &str = include_str!("../migrations/0043_terminal_replace.sql");
pub const MIGRATION_0042: &str = include_str!("../migrations/0042_mirror_stop_readback.sql");
mod schema;
