...
export type FollowSettings = { credential_id: string; allocated_capital: string; multiplier: string; max_order_notional: string; max_total_notional: string; max_deviation_bps: number; allowed_symbols: string[] };
