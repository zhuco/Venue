...
| 本地 Ubuntu Node 编译 | `scripts/Build-VenueUbuntu.ps1` | `G:\Build\Venue\ubuntu`，Cargo 复用 slot-2；固定 commit、六 ELF、manifest/SHA256，`-CheckOnly` 零写；详见 [构建政策](scripts/BUILD_POLICY.md) |
