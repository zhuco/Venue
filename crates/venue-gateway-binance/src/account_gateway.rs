...
pub use account_gateway_projection::{BinanceCompletedProjection, BinanceProjectionRead};
...
pub struct BinanceAccountGateway {
    ...
    stream_projection: Option<account_stream_projection::AccountStreamProjection>,
