...
pub const PLACE_STRATEGY_ORDER: &str = "/api/v3/trade/place-strategy-order";
pub const CANCEL_STRATEGY_ORDER: &str = "/api/v3/trade/cancel-strategy-order";
pub const UNFILLED_STRATEGY_ORDERS: &str = "/api/v3/trade/unfilled-strategy-orders";
pub const HISTORY_STRATEGY_ORDERS: &str = "/api/v3/trade/history-strategy-orders";
